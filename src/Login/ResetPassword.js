...
const ResetPassword = ({ onLogin }) => {
  ...
  return (
    <Box bg={useColorModeValue("gray.100", "gray.800")} minH="100vh" display="flex" alignItems="center" justifyContent="center">
      <Box bg={useColorModeValue("white", "gray.700")} p={8} rounded="lg" shadow="md" w="full" maxW="md">
        ...
        <form onSubmit={handlePasswordReset}>
          <VStack spacing={4}>
            ...
            <Button type="submit" colorScheme="blue" w="full">Restablecer Contraseña</Button>
            <Button variant="link" colorScheme="blue" onClick={onLogin}>Volver a Iniciar Sesión</Button>
          </VStack>
        </form>
